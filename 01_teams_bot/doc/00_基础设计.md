...
# 在 Microsoft Teams 中添加 AI 机器人的实施方案（Python 开发，非 Azure 平台部署，集成 AI 服务）
...
*   **开发环境：**
    ...
    *   **AI 服务访问凭证：** 例如 OpenAI API 密钥，或您选择的其他 AI 服务的 API 密钥和端点。
...
*   确保您的 Python 代码能够正确调用您选择的 AI 服务 API（如 OpenAI）。
